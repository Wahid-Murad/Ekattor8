...
import 'package:ekattor_8/profile.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  getLogin() async{
    ...
    if(response.statusCode==200){
      ...
      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>ProfilePage(key: userModel.message,)));
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Enter Your Credentials to Access Your Account",style: GoogleFonts.roboto(fontSize: 13,fontWeight: FontWeight.w400,),),
                      SizedBox(
                        height: 30,
                      ),
                      Column(
